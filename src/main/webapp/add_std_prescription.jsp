                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td width="20%" align="center">
                                        <img src="http://localhost:8090/MedicalCentre/RetrieveImage?regNo=<%= request.getParameter("reg_id") %>" width="150" height="150" alt="Image not found"/>
                                    </td>
...
<script type="text/javascript">
	...
	//alert(gen_adv_id);
		...
		else
		{
			...
			var oe_name = $(this).val();
                       ...
                       // alert(t);
                        $.ajax({
                           type: "POST",
                           url: "http://localhost:8090/MedicalCentre/GetOEValue",
                           data: { oename: oe_name },
                           dataType: "json",
        ...
        $('#medicine_type').change(function(){
            ...
            $.ajax({
               type: "POST",
               url: "http://localhost:8090/MedicalCentre/GetMedInfo",
    ...
    //alert(gen_advstr);
               ...
               $.post("http://localhost:8090/MedicalCentre/SubmitStdPrescription",
